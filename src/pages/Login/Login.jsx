...
const Login = () => {
  return (
    <div className="bg-base-100 min-h-[90vh] flex justify-center items-center">
      <div class=" card-body bg-white p-6 rounded-xl shadow-2xl w-full max-w-sm mx-auto">
        <form>
          <div className="mb-6 text-center">
            <h2 class="text-3xl font-semibold  mb-2 text-gray-800">Login</h2>

            <p className="text-gray-600">
              Don't have an account?{" "}
              <Link className="custom-linear-text " to="/authentication/register">
                Register Now
              </Link>
            </p>
          </div>
